...
This gives you details on who has reviewed your pull request. If someone has participated, but not given you a 'LGTM', this will tell you.
+status+ prevents you from having to open a browser to find out where your pull request is at. But in case you want to take a look, we'll give you the option to open it for you. (OSX/Ubuntu only)
