...
== Quickstart
  $ git reflow setup
Link your github account so we can create pull requests
...
Create a pull request for your branch against master
  ...
  $ git reflow deliver
If your code is 'LGTM'd, merge to master and delete the feature branch
...
After making commits to your branch, run +review+. Didn't push it up? We don't care, we'll do it for you.
  ...
  Successfully created pull request #35: Bootstrapping the readme. This commit is so I can show how review works
...
You kick butt. You've got your code reviewed and now you're ready to merge it down to master and deploy. +deliver+ will take care of all of the steps for you to make this happen.

+deliver+ requires you to have a pull request, so you'll be protected on those mornings when the coffee isn't working yet.
